        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <p className="about-description">
              สวัสดีครับ เราชื่อ นข เราหลงใหลในการเปลี่ยนไอเดียให้กลายเป็นเว็บไซต์ที่ใช้งานได้จริง 
              เราเริ่มต้นเส้นทางนี้ด้วยการเรียนรู้ HTML, CSS และ JavaScript และตอนนี้กำลังสนุกกับการใช้ 
              React เพื่อสร้างส่วนหน้าเว็บที่มีประสิทธิภาพ
            </p>
            <p className="about-description">
              เรายังอยู่ในช่วงของการเรียนรู้และฝึกฝนอยู่ครับ บางครั้งก็เจอปัญหาที่ต้องใช้เวลาแก้ 
              แต่เราก็ไม่เคยท้อ เราเชื่อว่าทุกปัญหามีทางออกเสมอ และพร้อมที่จะรับมือกับความท้าทายใหม่ๆ 
